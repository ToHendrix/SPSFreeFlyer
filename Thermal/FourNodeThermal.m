...
kSR=0.0001;%Thermal Conductivity W/mKZ
...
hQR=0.00001;%Thermal conductivity over an alu interface in vacuum

%%Ring Characteristics
%%
mr=1; %mass of the ring
cpr=1;%specific heat capacity of the ring
...
%%
%SVM Characteristics
mSVM=1;%mass of the quadpack
cpSVM=1; %specific heat of the service module set to 200J/kgK
%%
%QuadPack Characteristics
mQP=1;%mass of the quadpack
cpQP=1; %specific heat of the quadpack
